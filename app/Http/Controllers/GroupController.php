...
class GroupController extends Controller
{
    ...
    public function create(Request $request)
    {
       ...
       $group->participants()->attach(auth()->user()->id);
        ...
        return redirect('/home')->with('success', 'Your chat room has been created');
    }
    ...
    public function join(Request $request)
    {
        ...
        if ($group)
        {
            try 
            {
                ...
                return redirect('/home')->with('success', 'Chat room joined');
            } 
            catch (\Throwable $th) 
            {
                //Display an error if the user is already in the group
                return redirect()->back()->with('error', 'You are already a member of this chat room');
            }
        }
        else
        {
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/group/'. $id)->with('success', 'Chat room name has been changed');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('/home')->with('success', 'Chat room has been deleted');
    }
